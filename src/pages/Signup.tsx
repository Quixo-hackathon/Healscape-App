  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signUpError) {
        ...
        // or we can show a verification message if email verification is required
      }
    } catch (err: any) {
        ...
        <Card className="w-full border-healscape-gray-light soft-shadow hover:shadow-md transition-all card-hover">
          <CardHeader className="space-y-2">
            <div className="flex justify-center mb-2">
              <div className="w-16 h-16 rounded-full bg-healscape-coral/10 flex items-center justify-center">
                <UserPlus className="h-8 w-8 text-healscape-coral" />
              </div>
            </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-healscape-text-primary font-medium">Full Name</Label>
                <Input
                  id="name"
                  type="text"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-healscape-text-primary font-medium">Confirm Password</Label>
                <div className="relative">
                  <Input
                    id="confirmPassword"
          ...
          <CardFooter className="flex flex-col space-y-4 border-t border-healscape-gray-light pt-4">
            <div className="text-center w-full">
              <span className="text-healscape-text-secondary">Already have an account? </span>
              <Link to="/login" className="text-healscape-teal hover:text-healscape-teal/80 hover:underline font-medium transition-colors">
                Sign in
              </Link>
            </div>
          </CardFooter>
